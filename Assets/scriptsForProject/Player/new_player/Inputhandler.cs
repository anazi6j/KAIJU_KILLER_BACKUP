    ...
    public class Inputhandler : MonoBehaviour
    {
       ...
       public bool maru_input;
        ...
        void GetInput()
        {
            ...
            r1_input = Input.GetButton("PS4_R1");
            r2_input = Input.GetButton("PS4_R2_bool");
            
            l1_input = Input.GetButton("PS4_L1");
            l2_input = Input.GetButton("PS4_L2_bool");
            maru_input = Input.GetButton("PS4_maru");
            sankaku_input = Input.GetButton("PS4_sankaku");
            shikaku_input = Input.GetButton("PS4_shikaku");
            batsu_input = Input.GetButton("PS4_bastu");
            DpadXRight = Input.GetAxis("PS4_DegitalPadH") >0;
            DpadXLeft = Input.GetAxis("PS4_DegitalPadH") <0;
            DpadYUp = Input.GetAxis("PS4_DegitalPadV") > 0;
            DpadYDown = Input.GetAxis("PS4_DegitalPadV") < 0;
            
            //l1とl2は後回し
            rightAxis_down = Input.GetButtonUp("PS4_R3");//R3ボタン
            //ポーズ画面で使用
