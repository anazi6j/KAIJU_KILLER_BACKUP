...
namespace EquipmentManager
{
    ...
    public class EquipmentIDmanager : MonoBehaviour
    {
        ...
        {
            /*
            PlayerPrefs.SetInt("Head_Pointer", Head_pointer);
            PlayerPrefs.SetInt("RightArm_Pointer", RightArm_pointer);
            PlayerPrefs.SetInt("LeftArm_Pointer", 0);
            PlayerPrefs.SetInt("Leg_pointer", 0);
            PlayerPrefs.SetInt("Body_Pointer", 0);
            */
        }
